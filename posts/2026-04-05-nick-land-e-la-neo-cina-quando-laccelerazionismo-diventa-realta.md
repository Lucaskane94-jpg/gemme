...
---
C’è qualcosa di paradossale nel vedere [Nick Land](https://www.wired.it/article/nick-land-filosofo-cyberpunk/) vivere in Cina.Non tanto per la geografia,ma per quello che rappresenta.Perché se **negli anni ’90 era il teorico di un capitalismo che accelera fino al collasso**,oggi si trova immerso in un sistema che quella accelerazione la sta praticando davvero,senza più teoria,senza più metafora. La Cina,più che un paese,inizia a sembrare un prototipo.

## Dall’accelerazionismo alla realtà operativa

Negli anni della CCRU a Warwick,Land costruiva una visione quasi delirante del **futuro,un mix di filosofia,cyberpunk e teoria del capitale come macchina** autonoma.[L’idea era semplice e brutale:lasciare che il capitalismo acceleri fino a superare l’umano](https://www.2duerighe.com/rubriche/193846-nick-land-il-filosofo-che-ha-guardato-troppo-a-lungo-nel-futuro.html),spingendo la tecnologia oltre ogni controllo.All’epoca sembrava fantascienza. Oggi sembra cronaca.
...
Non è evoluzione lineare.È salto di stato.

**La Cina diventa una macchina che integra umano e tecnologia** senza preoccuparsi troppo dei confini.Il singolo non è più il centro,è una componente,quasi un modulo dentro qualcosa di più grande.
...
In questo scenario,l’individuo perde centralità.Non scompare,ma cambia ruolo.Diventa parte di un sistema più grande,che lo osserva,lo ottimizza,lo integra.

È una logica diversa da quella occidentale,dove l’individuo è ancora il punto di riferimento teorico.

Qui il riferimento è il sistema.

E il sistema evolve più velocemente di chi lo abita.

Una direzione che non sembra tornare indietro
...
È capire se quello che stiamo vedendo è già il presente di qualcun altro.