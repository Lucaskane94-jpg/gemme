---
title: "Dark Matter: la serie TV che usa il multiverso per ricordarci che la
  vita vera era già qui"
date: 2026-05-17
description: "Una riflessione su Dark Matter, la serie Apple TV che usa il
...
La serie sembra dirci che il successo, senza qualcuno a cui tornare, è solo una stanza illuminata male. Puoi aver vinto in una versione della tua vita, puoi essere diventato più importante, più ricco, più ammirato, più vicino all’idea che avevi di te stesso, ma se per arrivarci hai perso la possibilità di amare ed essere amato, cosa hai davvero guadagnato?



## Arrivare alla fine senza rimpianti
...
La serie colpisce perché dietro la sua architettura da thriller c’è una domanda elementare: quando saremo sul punto di morte, cosa rimpiangeremo davvero? Non credo rimpiangeremo di non aver fatto una call in più, di non aver scalato una posizione aziendale, di non aver comprato l’ennesimo oggetto, di non aver vinto una discussione inutile. Rimpiangeremo le telefonate non fatte, gli abbracci rimandati, le persone lasciate andare per orgoglio, i giorni consumati nell’ansia di diventare qualcosa mentre qualcuno, accanto a noi, chiedeva solo presenza. Per questo Dark Matter funziona così bene anche oltre la fantascienza. Perché il multiverso è solo una metafora estrema di un dolore comunissimo: la nostalgia per le vite che non abbiamo vissuto. Tutti abbiamo un piccolo Jason Dessen dentro, una parte che ogni tanto guarda indietro e si chiede se la scelta giusta fosse un’altra.Ma la serie non ci consola dicendo che abbiamo sempre scelto bene. Sarebbe falso. A volte scegliamo male. A volte sprechiamo tempo. A volte feriamo le persone. A volte ci perdiamo in desideri che non ci appartengono davvero. Però Dark Matter suggerisce anche che continuare a inseguire ogni possibilità perduta può diventare una forma di dannazione. Non si può vivere in tutte le vite. Bisogna, a un certo punto, scegliere di abitare la propria.
...
Dark Matter ci ricorda che spesso ciò che chiamiamo normalità è in realtà il nostro miracolo privato. Solo che ce ne accorgiamo quando qualcuno ce lo porta via, o quando immaginiamo di non poterci più tornare. E allora una cucina, una casa, una voce familiare, un figlio che ti guarda, un amico che ti conosce davvero, diventano più preziosi di qualunque universo alternativo.
...
## Il significato di Dark Matter: desiderare meglio, non desiderare di meno
